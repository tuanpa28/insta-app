...
export const MessageIcon = ({ className }: IIcon) => (
  <svg
...
export const BoxArrowUpRightIcon = () => (
  <svg
    aria-label=''
...
export const SavedIcon = ({ className }: IIcon) => (
  <svg
    aria-label='Saved'
    className={className}
    fill='currentColor'
...
export const HeartIcon = ({ className }: IIcon) => (
  <svg
    aria-label='Like'
    className={className}
    fill='currentColor'
...
export const HeartActiveIcon = ({ className }: IIcon) => (
  <svg
    aria-label='Unlike'
    className={className}
    fill='currentColor'
...
export const LogoImgIcon = ({ className }: IIcon) => (
  <svg
...
export const LogoTextIcon = ({ className }: IIcon) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    aria-label='Instagram'
    className={className}
