...
export const ThreadsIcon = ({ width = 24, height = 24, className }: IIcon) => (
  <svg
    aria-label=''
    className={className}
    fill='currentColor'
...
export const ImageVideoIcon = ({ width = 96, height = 77, className }: IIcon) => (
  <svg
...
export const LogoImgIcon = ({ width = 24, height = 24, className }: IIcon) => (
  <svg
...
export const LogoTextIcon = ({ width = 103, height = 29, className }: IIcon) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    aria-label='Instagram'
    className={className}
